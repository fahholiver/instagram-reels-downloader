...
TRANSLATIONS = {
    "en": {
        ...
        "bg_color_label": "Template background colour:",
        ...
        "previous_video_kept": "📎 Kept the previously uploaded video ({name}). Upload a new one to replace it.",
    ...
    "pt": {
        ...
        "bg_color_label": "Cor de fundo do template:",
        ...
        "previous_video_kept": "📎 Mantido o vídeo enviado antes ({name}). Envie outro pra substituir.",
